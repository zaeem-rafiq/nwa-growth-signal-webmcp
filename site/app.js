(() => {
  ...
  async function registerWebMCP() {
    ...
    try {
      ...
      setWebMCPState("ready", "WebMCP ready · 4 tools exposed", "Your agent can search, inspect evidence, stage a local brief, and list verified status changes in this shared interface.");
    } catch (error) {
      console.error(error);
